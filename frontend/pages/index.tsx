        ...
        <div className="container-custom rounded-3xl border border-[var(--border-subtle)] bg-[var(--surface-elevated)] px-5 py-6 grid gap-6 items-start md:px-8 md:py-7 md:grid-cols-3">
          <div>
            ...
            <p className="text-[12px] text-[var(--text-muted)]">
              Если после визита что‑то не устраивает в стрижке или бороде, клуб
              берёт на себя корректировку — важно, чтобы вам было комфортно.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-[12px] text-[var(--text-muted)]">
              Стоимость ритуала фиксируется заранее. Вы заранее понимаете, за
              что платите, без сюрпризов на кассе.
            </p>
          </div>
        </div>
      </section>
