        ...
        <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="max-w-xl space-y-6">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:flex-wrap">
              ...
              <button
                type="button"
                className="btn-secondary-dark w-full border border-transparent text-[11px] uppercase tracking-[0.2em] text-club-soft hover:border-[rgba(245,239,230,0.4)] hover:bg-[rgba(245,239,230,0.04)] sm:w-auto"
