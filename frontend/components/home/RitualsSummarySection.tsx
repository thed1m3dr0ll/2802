    ...
    >
      <div className="container-custom flex flex-col items-center">
        <div className="w-full max-w-3xl text-center mb-10 mx-auto">
          ...
          <h2 className="text-3l md:text-4xl font-semibold mb-3">
        ...
        <div className="w-full max-w-lg space-y-6 mx-auto">
          <RitualCard
            ...
            description="Ритуал для тех, кто приходит в клуб «Джентльмены Культуры» впервые. Консультация, мужская стрижка, мытьё головы, укладка и понятные рекомендации, как носить новую форму без стилиста под боком."
            meta="от 1 800 ₽ · около 60 минут · мужская стрижка"
          ...
          <RitualCard
            ...
            description="Когда голова и борода давно живут разной жизнью. Мастер собирает всё в единый образ: мужская стрижка, моделирование бороды, форма, линии, длина и уход, чтобы зеркало радовало не только в день визита."
            meta="от 2 800 ₽ · около 90 минут · стрижка + борода"
            cta="выбрать этот ритуал"
          ...
          <RitualCard
            ...
            meta="от 800 ₽ · 30–45 минут · коррекция контура"
            cta="выбрать этот ритуал"
