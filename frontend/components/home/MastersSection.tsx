      ...
      <div className="container-custom">
        <div className="mx-auto mb-10 max-w-3xl text-center">
          <p className="label-small mb-2 text-[var(--text-muted)]">
            команда клуба «Джентльмены Культуры»
          </p>
          <h2 className="mb-3 text-3xl font-semibold text-[var(--text-dark-strong)] md:text-4xl">
            Мастера, которым можно доверить голову и бороду
          </h2>
          <p className="text-[14px] text-[var(--text-muted)] md:text-[15px]">
            Здесь не подбирают свободное кресло по графику. В клубе работают
            мастера с характером и вкусом, а вы выбираете человека, с которым
            вам комфортно говорить и смотреть в зеркало после ритуала.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          <MasterCard
            ...
            description="Замечает детали, которые другие пропускают. Любит чистые формы, аккуратные переходы и такую укладку, которую гость сможет без труда повторить дома."
          ...
          <MasterCard
            ...
            description="Спокойный характер и уверенная рука. Делает современные стрижки и фейды без лишнего шоу — когда важнее результат и ощущение собранности, чем разговоры."
          ...
          <MasterCard
            ...
            description="Собирает образ целиком: стрижка, борода, линии и переходы — чтобы всё выглядело как единая картинка без крайностей и экспериментов ради экспериментов."
          ...
          <MasterCard
            ...
            description="Отвечает за почерк клуба и сложные запросы. Настраивает форму под характер и образ жизни, курирует ночные ритуалы и обучает команду мастеров."
...
function MasterCard({
  ...
  return (
    <article className="card-paper-lifted group flex flex-col justify-between rounded-2xl border border-[var(--card-border)]/80 bg-[var(--paper-bg)] p-6 shadow-[0_18px_40px_rgba(0,0,0,0.15)] transition-transform duration-300 ease-out hover:-translate-y-1.5 hover:border-[var(--accent-gold-soft)] hover:shadow-[0_22px_48px_rgba(0,0,0,0.25)]">
        ...
        <div className="h-20 w-20 overflow-hidden rounded-full bg-gray-200 ring-1 ring-transparent transition-all duration-300 group-hover:ring-[var(--accent-gold-soft)]">
          <div className="relative h-full w-full">
            <Image
              ...
              fill
              sizes="80px"
              className="master-photo object-cover brightness-[1.03] contrast-[1.04]"
            />
          </div>
        </div>
        <div>
